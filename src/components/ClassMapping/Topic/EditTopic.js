...
const EditTopicMaster = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      const apiUrl = `${url}/OfflineTopicMaster/Id?Id=${TopicId}`;
      const token = sessionStorage.getItem('token');

      const formDataToSend = new FormData();
      formDataToSend.append('class', formData.class);
      formDataToSend.append('subject', formData.subject || 1);
      formDataToSend.append('lesson', formData.lesson || 3);
      formDataToSend.append('videoLink', formData.videoLink || "string");
      formDataToSend.append('topic', formData.topic);
      formDataToSend.append('Content', formData.Content);
      formDataToSend.append('TopicPath', formData.pdfFile);
...
export default EditTopicMaster;
